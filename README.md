...
```
roc(scores::AbstractVector{T}, labels::AbstractVector{U}, truelabel::L; reverseordered::Bool=false)
```
...
```
roc(scores::AbstractVector{R}, labels::BitVector; reverseordered::Bool=false)
```
